...
public class TexturesStreet : ISpriteProperties<StreetPart>
{
    public IDictionary<StreetPart, Rectangle> SpriteContent { get; }
    public Texture2D Texture { get; }

    public TexturesStreet(Game game)
    {
        this.Texture = game.Content.Load<Texture2D>("RpgUrban/Street");
        this.SpriteContent = new Dictionary<StreetPart, Rectangle>
        {
