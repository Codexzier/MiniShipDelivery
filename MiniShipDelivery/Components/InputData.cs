...
public class InputData : IInputData
{
    ...
    public Func<Vector2, SizeF, string, bool> GetMouseButtonReleasedStateLeft { get; set; }
    public Func<Vector2, SizeF, string, bool> GetMouseButtonReleasedStateRight { get; set; }
}